...
{
  build_teapot();
  /*DIFF: */ glGenVertexArrays(1,&vao);
  /*DIFF: */ glBindVertexArray(vao);  
  ...
  /*DIFF: */ attribute_coord3d = glGetAttribLocation(program, "coord3d");
  /*DIFF: */ attribute_v_color = glGetAttribLocation(program, "v_color");
